    ...
    if gl == False:
        ...
        if k == False:
            ...
            if files:
                ...
                k = await query.message.edit(script.I_CUDNT)
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        return await query.answer("Yᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ!\nKɪɴᴅʟʏ ᴠᴇʀɪғʏ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ!", show_alert=True)
                    else:
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/FHD24x7FeedBot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            find = search.split(" ")
            search = ""
            removes = ["in", "upload", "series", "full", "horror", "movie", "series", "episode", "anime", "netflix", "film", "dub", "dubbed", ":", "kdrama", "k-drama"]
            for x in find:
    ...
    btn.insert(0, [
        InlineKeyboardButton("⚡ Cʜᴇᴄᴋ Bᴏᴛ PM ⚡", url=f"https://telegram.me/{temp.U_NAME}")
    ])
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        k = await msg.reply(script.I_CUDNT.format(mv_rqst),
