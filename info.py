...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/gdrivedl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/StrimFlix')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001652564383))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'TOP_HD_MOVIE_OFFICIAL')
